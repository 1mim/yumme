        ...
        <div className="bg-white shadow-2xl grid grid-cols-3 gap-4 w-2/3 p-3 h-38 mx-auto rounded-lg align-middle">
            ...
            {categories !== [] &&
                    categories.map(category =>
                        ...
                        <span className="flex-auto bg-red-350 font-semibold text-gray-600 hover:bg-red-550 hover:shadow hover:text-white m-2 py-2 px-5 text-white text-xs text-center font-sans leading-10 rounded-full">
