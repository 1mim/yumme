...
const Thumbnails = ({ img, name, category, cuisine }) => {
    ...
    return (
            ...
            <h3 className="flex-1 items-center p-2 text-xl font-black leading-6 capitalize">{name}</h3>

                <div class="flex-1 items-end grid grid-cols-2 p-2 mx-2 divide-x divide-red-300 text-xs font-sans text-gray-500 border-t border-red-300 border-dotted">
                <p>{category}</p>
                <p>{cuisine}</p>
                </div>
            </div>
